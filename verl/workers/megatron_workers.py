...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def compute_log_prob(self, data: DataProto, calculate_entropy: bool = False):
        ...
        # Check if calculate_entropy is in meta_info, prioritize meta_info over function parameter
        calculate_entropy = data.meta_info.pop("calculate_entropy", calculate_entropy)
